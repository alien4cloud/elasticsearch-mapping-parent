...
public class ESGenericSearchDAO extends ESGenericIdDAO implements IGenericSearchDAO {
    ...
    @Override
    public <T> GetMultipleDataResult<T> search(Class<T> clazz, String searchText, Map<String, String[]> filters, QueryBuilder customFilter, String fetchContext,
    ...
    public <T> FacetedSearchResult facetedSearch(Class<T> clazz, String searchText, Map<String, String[]> filters, QueryBuilder customFilter,
        ...
        finalResponse.setFacets(parseFacets(searchResponse.getAggregations()));
    ...
    private <T> SearchResponse doSearch(Class<T> clazz, String searchText, Map<String, String[]> filters, QueryBuilder customFilter, String fetchContext,
    ...
    private String[] doSelectPath(String index, String[] types, QueryBuilder queryBuilder, SortOrder sortOrder, String path, int from, int size) {
        ...
        if (!somethingFound(searchResponse)) {
            ...
            for (int i = 0; i < results.length; i++) {
                Map<String, Object> result = searchResponse.getHits().getAt(i).getSource();
                results[i] = String.valueOf(result.get(path));
            }
            return results;
        }
    }
